  ...
  return (
    <div>
      ...
      >
        ...
        <div
          className={`${montserrat.className} flex flex-col items-center justify-center gap-4`}
        >
          {isDragActive ? (
      ...
      <section className="mt-6">
        ...
        {rejected.length > 0 && (
          <div>
            <h3
              className={`${montserrat.className} title mt-24 border-b pb-3 text-lg font-semibold text-gray-600`}
            >
              Rejected Files
            </h3>
